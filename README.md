...
同一 Runtime 可以启动不同 scheme 主版本的任务，前提是它们实现相同 CLI 和完成清单协议。更改此进程边界协议才需要调整 Runtime。Jupyter 的研究 SDK 已迁入 `scheme.apps`、`scheme.data`，详见 [scheme README](../algos/scheme/README.md)。
